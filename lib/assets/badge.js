(function (){
  ...
  var LINK // boolean for the link only mode, from query param
  ...
  function replace (script){
    ...
    if (!LINK) {
      ...
      var hideCount = document.createElement('style')
      hideCount.innerHTML = '.slack-count { visibility: hidden; }'
console.log(iframe.getElementsByTagName('head'));
      //iframe.getElementsByTagName('head')[0].appendChild(hideCount)
    }
